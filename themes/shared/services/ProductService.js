...
export const ProductService = {
    ...
    async sendData(
        ...
        if(additional_images.additional_image_1) formData.append("additional_image_1", additional_images.additional_image_1)
        if(additional_images.additional_image_2) formData.append("additional_image_2", additional_images.additional_image_2)
        if(additional_images.additional_image_3) formData.append("additional_image_3", additional_images.additional_image_3)
